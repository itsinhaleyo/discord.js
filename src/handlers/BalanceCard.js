...
class BalanceCard extends Builder {
    ...
    async render() {
        const { username, avatar, balance } = this.options.getOptions();
        ...
        return JSX.createElement(
            ...
            JSX.createElement(
                ...
                JSX.createElement("div", { style: { fontSize: "24px", color: "#f1c40f", marginTop: "10px", display: "flex" } }, `Balance: 💵 ${balance}`)
            )
        );
    }
}
